...
const AuthProvider = ({ children }) => {
    ...
    return (
        <AuthContext.Provider value={{ isLink, addRegistrationLink, isToken, isAuthenticated, authToken, storelinkData, checkRegistrationLink, deleteUser, adminListPage, setUserData, adminTotal, adminData, total, loginPage, signupPage, getUserByID, updateUserPage, userData, userListPage, data, setQueryString }}>
            {children}
